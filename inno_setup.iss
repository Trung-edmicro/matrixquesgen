...
Name: "playwright"; Description: "Cài đặt Playwright Chromium (để xuất biểu đồ vào DOCX, ~150MB)"; GroupDescription: "Thành phần tuỳ chọn:"; Flags: unchecked
...
Name: "{group}\Cài đặt Playwright (Biểu đồ DOCX)"; Filename: "{app}\install_playwright.bat"
...
Filename: "{app}\install_playwright_silent.bat"; Description: "Đang cài đặt Playwright Chromium..."; Flags: runhidden nowait; Tasks: playwright
